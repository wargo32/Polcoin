...
unlocked to sign the polcoin-qt.app bundle.
...
allowing somebody to distribute a polcoin-qt.app or polcoin-qt-setup.exe with a valid
...
that the polcoin-qt.exe file inside the installer had not been tampered with.
