...
if not vars().has_key('ENABLE_WALLET'):
    ENABLE_WALLET=0
if not vars().has_key('ENABLE_polcoind'):
    ENABLE_polcoind=0
...
#Set env vars
buildDir = BUILDDIR
os.environ["polcoind"] = buildDir + '/src/polcoind' + EXEEXT
os.environ["BITCOINCLI"] = buildDir + '/src/polcoin-cli' + EXEEXT
...
if(ENABLE_WALLET == 1 and ENABLE_UTILS == 1 and ENABLE_polcoind == 1):
    ...
    print "No rpc tests to run. Wallet, utils, and polcoind must all be enabled"
