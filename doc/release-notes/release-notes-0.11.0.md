...
- #5809 `46bfbe7` Add polcoin-cli man page
...
- #5849 `41259ca` contrib/init/polcoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6116 `30dc3c1` [OSX] rename polcoin-qt.app to Bitcoin-Core.app
- #6168 `b3024f0` contrib/linearize: Support linearization of testnet blocks
- #6098 `7708fcd` Update Windows resource files (and add one for polcoin-tx)
