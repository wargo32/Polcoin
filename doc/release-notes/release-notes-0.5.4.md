...
http://gitorious.org/bitcoin/polcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix polcoin-qt notifications under Growl 1.3.
Increase required age of polcoin-qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing polcoin-qt over it. (Windows)
