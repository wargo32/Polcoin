...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ...
        # optional bypass polcoind rpc basic auth
...
This allows running polcoind without having to do any manual configuration.
...
polcoind can now (optionally) asynchronously notify clients through a
