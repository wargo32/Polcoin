...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatPolcoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + PolcoinUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatPolcoinURI(info));
}
