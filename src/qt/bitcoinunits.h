...
#ifndef Polcoin_QT_PolcoinUNITS_H
#define Polcoin_QT_PolcoinUNITS_H
...
/** Polcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PolcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PolcoinUnits(QObject *parent);

    /** Polcoin units.
      @note Source: https://en.Polcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        PLC,
...
typedef PolcoinUnits::Unit PolcoinUnit;

#endif // Polcoin_QT_PolcoinUNITS_H
