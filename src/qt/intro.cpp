...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/Polcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Polcoin Core"),
     ...
     * override -datadir in the Polcoin.conf file in the default data directory
     * (to be consistent with Polcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
