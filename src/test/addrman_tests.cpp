...
BOOST_AUTO_TEST_CASE(addrman_simple)
{
    ...
    CNetAddr source = CNetAddr("252.2.2.2:9338");
    ...
    CService addr1 = CService("250.1.1.1:9338");
    addrman.Add(CAddress(addr1), source);
    BOOST_CHECK(addrman.size() == 1);
    CAddrInfo addr_ret1 = addrman.Select();
    BOOST_CHECK(addr_ret1.ToString() == "250.1.1.1:9338");

    // Test 3: Does IP address deduplication work correctly. 
    //  Expected dup IP should not be added.
    CService addr1_dup = CService("250.1.1.1:9338");
    ...
    //  have two addrs.
    CService addr2 = CService("250.1.1.2:9338");
...
BOOST_AUTO_TEST_CASE(addrman_ports)
{
    ...
    BOOST_CHECK(addr_ret2.ToString() == "250.1.1.1:9338");
    ...
    BOOST_CHECK(addr_ret3.ToString() == "250.1.1.1:9338");
}
