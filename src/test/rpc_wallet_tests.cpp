...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CPolcoinAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CPolcoinAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CPolcoinAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CPolcoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CPolcoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CPolcoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
