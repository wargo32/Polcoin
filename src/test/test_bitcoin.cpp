...
#define BOOST_TEST_MODULE Polcoin Test Suite

#include "test_Polcoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_Polcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
