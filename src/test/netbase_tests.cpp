...
{
    BOOST_CHECK(TestSplitHost("www.Polcoin.org", "www.Polcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.Polcoin.org]", "www.Polcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.Polcoin.org:80", "www.Polcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.Polcoin.org]:80", "www.Polcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:9338", "127.0.0.1", 9338));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:9338", "127.0.0.1", 9338));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9338", "::ffff:127.0.0.1", 9338));
    BOOST_CHECK(TestSplitHost("[::]:9338", "::", 9338));
    BOOST_CHECK(TestSplitHost("::9338", "::9338", -1));
    BOOST_CHECK(TestSplitHost(":9338", "", 9338));
    BOOST_CHECK(TestSplitHost("[]:9338", "", 9338));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:9338", "127.0.0.1:9338"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:9338", "[::]:9338"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
